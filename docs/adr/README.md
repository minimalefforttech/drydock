...
| [0003](0003-webview-and-host-contract.md) | Webview and host contract | Accepted | Webviews render untrusted text safely and talk to the host through validated messages. |
